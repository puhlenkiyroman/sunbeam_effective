    ...
    return (
        <header className={styles.header}>
            <div className={styles.logo}>
                <img src="/png/sun_in_header.png" alt="Логотип" />
            </div>
            ...
            <div className={styles.layer2}>
                ...
                <li> <img src="/png/2гис.png" alt="2гис" onClick={clickHandler}/> </li>
                <li> <img src="/png/вк.png" alt="вк" onClick={clickHandler1}/> </li>
            </div>
        </header>
    );
}
